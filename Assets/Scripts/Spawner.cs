...
{
    //этот класс реализует шаблон проектирования Одиночка. 
    //может существовать только один экземпляр Спаунер, поэтому сохраним его в статической переменной s
    ...
    //далее поля позволяют настраивать стайное поведение объектов boid
